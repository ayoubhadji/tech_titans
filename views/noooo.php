            ...
            <div class="app-sidebar-wrapper">
                <div class="app-sidebar sidebar-shadow">
                    <div class="app-header__logo">
                        <a href="listeuser.php" data-toggle="tooltip" data-placement="bottom" title="KeroUI Admin Template"
                            class="logo-src"></a>
                                                                        ...
                                                                        <div><span
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <p>Lorem ipsum dolor sic amet, today at
                                                                                    <a href="javascript:void(0);">10:00
                                                                                        PM</a>
                                                                                </p><span
                                                                                    class="vertical-timeline-element-date"></span>
                                                                            </div>
                    ...
                    <div class="app-inner-layout app-inner-layout-page">
                        <div class="app-inner-layout__wrapper">
                            <div class="app-inner-layout__content pt-1">
                                ...
                                ?>
                                                        <h5 class="card-title">user Infos</h5>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <input type="text" class="form-control"
                                                                        id="iduser " name="iduser" value="<?php echo $user['iduser']; ?>"
                                                                        placeholder="iduser ">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <input type="text" class="form-control"
                                                                        id="nom" name="nom" value="<?php echo $user['nom']; ?>"
                                                                        placeholder="name">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <input type="text" class="form-control"
                                                                        id="prenom:" name="prenom:" value="<?php echo $user['prenom']; ?>"
                                                                        placeholder=" prenom ">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <input type="code" class="form-control"
                                                                        id="code" name="code"value="<?php echo  $user['code'] ; ?>" 
                                                                        placeholder="code">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="adresse">adresse</label>
                                                                <input type="text" class="form-control" id="adresse" value="<?php echo $user['adresse']; ?>"
                                                                    name="adresse" placeholder="adresse">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="numero">numero</label>
                                                                <div>
                                                                    <input type="text" class="form-control" id="numero" value="<?php echo $user['numero']; ?>"
