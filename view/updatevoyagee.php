...
if (
    ...
    if (
        ...
        $voyageeC->updatevoyagee($voyagee, $_POST["idvoyage"]);
        ...
        <div class="app-main">
            <div class="app-sidebar-wrapper">
                <div class="app-sidebar sidebar-shadow">
                    ...
                    <a href="listevoyagee.php" data-toggle="tooltip" data-placement="bottom" title="explore beyond"
                            class="logo-inverse"><img src="assets/images/logo-inverse.png" style="float: left; width: 100px; height: auto;"></a>
                        ...
                        <div class="app-inner-layout__wrapper">
                            <div class="app-inner-layout__content pt-1">
                                <div class="tab-content">
                                 ...
                                 $voyagee = $voyageeC->showvoyagee($_POST['idvoyage']);
