...
body {
    ...
    margin: 0;
    padding: 0;
    background-image: url('Miami.jpg'); /* Chemin vers votre image de fond */
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
        <a class="navbar-brand ml-2" href="" data-abc="true" style="color: white; font-size: 24px; display: flex; align-items: center;">
            ...
            <span style="color: white;">Explore<span style="color:#212121">Beyond</span></span>
        </a>
        <!-- Liens de navigation -->
        ...
        <?php foreach ($list as $p) { ?>
            ...
            <div class="post-hotel">Hôtel: <?= $p['hotel']; ?></div>
                    ...
                    <div class="post-footer">
                        ...
                        <a href="../../vue/reservation/listereservation.php" class="btn-reserver">Reserver</a>
