...
//require_once '../../controller/paiment/paiementC.php';
require_once '../../controller/paiement/factureC.php';
require_once '../../controller/paiement/userC.php';
require_once '../../controller/paiement/reservationC.php';
...
if(isset($_GET['paiement_id'])) {
    ...
    if($paiementDetails) {
        ...
        if($result !== false) {
            ...
            header("Location: http://localhost/web_project/vue/paiement/success_pay.php?" . http_build_query([
