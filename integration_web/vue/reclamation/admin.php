...
function generatePDF($list, $rp) {
   ...
   $pdf->SetDrawColor(74, 212, 137); // Couleur en RGB : red
   ...
   $pdf->SetTextColor(74, 74, 74); // Couleur en RGB : red
...
<html lang="en">
  ...
  th.dark-mode {
    ...
    color: #ff0000 !important; /* Dark mode text color for table headers */
  }
